...
class LoadData:
    def __init__(self, model, c3d_file, q_file, qdot_file):
        ...
        self.model = model
        self.nb_q = model.nb_q
        self.nb_qdot = model.nb_qdot
        self.nb_markers = model.nb_markers
    ...
    def dispatch_data(self, data, n_shooting, phase_time):
        """
        ...
        for i in range(len(n_shooting)):
            ...
            t_node = np.linspace(0, phase_time[i], n_shooting[i] + 1)
