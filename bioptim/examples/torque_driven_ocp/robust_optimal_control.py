...
def prepare_ocp(
    ...
    # objective_functions.add(ObjectiveFcn.Mayer.SUPERIMPOSE_MARKERS, node=Node.END, first_marker="bar", second_marker="marker_1", phase=2, weight=100000)
    ...
    # Phase 0
    x_bounds[0].min[0, :] = 3.14
    x_bounds[0][1, 0] = 0
    x_bounds[0][0, 0] = 3.14
    x_bounds[0].min[0, -1] = 2 * 3.14

    # Phase 1
    x_bounds[1].min[2, :] = 3.14
    x_bounds[1][[0, 1, 4, 5], 0] = 0
    # x_bounds[1].min[2, -1] = 3.1416
    # x_bounds[1].max[2, -1] = 2 * 3.1416

    # Phase 2
    x_bounds[2].min[2, -1] = 5/4 * 3.1416
    x_bounds[2].max[2, -1] = 2 * 3.1416
