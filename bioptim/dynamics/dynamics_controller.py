...
class DynamicsController:
    """
    A placeholder for the required elements to compute the dynamics (all time)
    For most of the part, DynamicsController will behave like NLP with the major difference that it will always
